...
export default function BagSection({
    ...
    return (
        <section
            className="relative border p-[9px]"
            style={{
                        ...
                        (item, index) =>
                            item ? (
                                <Link
                                    ...
                                    className="group relative flex h-[125px] cursor-pointer items-center justify-center overflow-hidden border p-[4px] no-underline transition-opacity duration-700 ease-film hover:opacity-80"
                                    style={{
                                        backgroundColor:
                                            theme.slot,
                                        borderColor:
                                ...
                                >
                                    ...
                                    <div
                                        className={`absolute inset-0 flex items-center justify-center text-[8px] tracking-[.08em] text-ink/35 ${item.images
                                                ?.transparent
                                                ? 'hidden'
                                                : ''
                                            }`}
