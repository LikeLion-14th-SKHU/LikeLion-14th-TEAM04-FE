                ...
                <div className="mx-auto w-full max-w-[1280px] px-[48px] pt-[38px] pb-[38px] max-[860px]:px-[22px]">
                    ...
                    <div className="mt-[28px] grid grid-cols-2 gap-[22px] max-[860px]:grid-cols-1">
                        ...
                        <div className="flex flex-col gap-[16px]">
                            <section className="border border-frame bg-[#f6f0e6] p-[18px]">
                            ...
                            <section className="border border-frame bg-[#f6f0e6] p-[18px]">
                                <div className="flex items-center justify-between gap-[12px]">
                                    ...
                                    <button
                                        ...
                                        className="h-[31px] cursor-pointer border border-[#b99b7c] bg-[#f7f0e7] px-[11px] text-[9px] text-clay transition-colors duration-700 ease-film hover:bg-[#f6f0e6] disabled:cursor-not-allowed disabled:opacity-40"
                                    >
                                ...
                                <div className="mt-[12px] flex flex-wrap gap-[8px]">
                                    {MATERIALS.map((item) => (
                                        <button
                                            ...
                                            className={`h-[32px] cursor-pointer border px-[14px] text-[10px] transition-colors duration-700 ease-film ${form.material === item
                                                ...
                                                : 'border-[#ddd1c1] bg-[#fcfaf6] text-ink/65 hover:border-clay'
                                                }`}
                                        >
                                            {item}
                                        </button>
                                    ...
                                    <button
                                        ...
                                        className={`h-[32px] cursor-pointer border px-[14px] text-[10px] ${form.material === '직접입력'
                                            ? 'border-ink bg-ink text-cream'
                                            : 'border-[#ddd1c1] bg-[#fcfaf6] text-ink/65'
                                            }`}
                                    >
                                        직접 입력
                                    </button>
